...
import {
  SquareCheck, Copy, ClipboardPaste, Scissors, Trash2, Undo2, Redo2, Bold, Italic, Underline, List, ListOrdered, AlignLeft, AlignCenter, AlignRight, LinkIcon, ChevronsLeft, ChevronLeft, ChevronUp, ChevronDown, ChevronRight, ChevronsRight, Eye, ClipboardList,
} from "lucide-react"
...
export function EditingToolbar(props: EditingToolbarProps) {
  const buttons: ActionButtonProps[] = [
    { label: "全選", onClick: props.onSelectAll, icon: SquareCheck },
    ...
    { label: "刪除", onClick: props.onDelete, icon: Trash2 },
